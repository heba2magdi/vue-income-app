    ...
    <div class="container" id="container">
        ...
        <div class="form-container sign-in-container">
            <div class="form_temp">
                ...
                <a onclick="sendResetEmail()">Forgot your password?</a>
...
.submission_button:focus {
    outline: none;
}

.submission_button.ghost {
    background-color: transparent;
    border-color: #FFFFFF;
}
...
.no-overlay {
    background: #ac9fbb;
    background: -webkit-linear-gradient(to right, #1D1E2C, #59656F);
    background: linear-gradient(to right, #1D1E2C, #59656F);
